...
class OrderRepository extends Repository
{
    ...
    public function create(array $data)
    {
        ...
        foreach ($order->items()->get() as $item) {
            ...
            if (!$sellerProduct->haveSufficientQuantity($item->additional['quantity']) && $product->haveSufficientQuantity($item->additional['quantity']) && $product->type != 'downloadable' && $product->type != 'booking' && $product->type != 'bundle') {
                continue;
            }
