...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('marketplace.admin.customer.store') }}" @submit.prevent="onSubmit">

            <div class="page-header">
                <div class="page-title">
                    <h1>
                        <i class="icon angle-left-icon back-link" onclick=" window.location = '{{ route('admin.marketplace.sellers.index') }}';"></i>
            ...
            <div class="page-content">
                ...
                <div class="form-container">
                    ...
                    <div class="control-group" :class="[errors.has('phone') ? 'has-error' : '']">
                        ...
                        <input type="text" v-validate="'integer'" class="control" name="phone" value="{{ old('phone') }}" data-vv-as="&quot;{{ __('admin::app.customers.customers.phone') }}&quot;">
