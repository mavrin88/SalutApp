            ...
            <div class="account-table-content">
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.general') }}'" :active="true">
                    ...
                    <div slot="body">
                        ...
                        <div class="control-group" :class="[errors.has('profile_background') ? 'has-error' : '']">
                            ...
                            <input type="color" class="control" name="profile_background" v-validate="'required'" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.profile.profile-background') }}&quot;" value="{{ old('profile_background') ?: $seller->profile_background }}">
                            <span class="control-error" v-if="errors.has('profile_background')" v-text="errors.first('profile_background')"></span>
                        </div>
