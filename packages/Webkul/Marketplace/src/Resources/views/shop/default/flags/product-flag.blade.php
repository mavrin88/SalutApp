@push('css')
<link rel="stylesheet" href="{{ asset('vendor/webkul/marketplace/assets/css/bootstrap.min.css') }}">
<style>
    .row{
                        ...
                        <div class="seller-product-col-2">
                            <div class="seller-flag-product">
                                <a title="{{ $sellerProduct->product->name }}" href="{{route('shop.productOrCategory.index', $sellerProduct->product->url_key)}}">
                                    <img class="img-fluid" src="{{product_image()->getProductBaseImage($sellerProduct->product)['small_image_url']}}" alt="">
                                </a>
                            </div>
                        </div>
                    @endif
