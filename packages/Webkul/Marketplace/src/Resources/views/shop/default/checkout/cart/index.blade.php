                                            ...
                                            @auth('customer')
                                                <span class="towishlist">
                                                    @if ($item->parent_id != 'null' ||$item->parent_id != null)
                                                        <a href="javascript:;" onclick="wishlistTempForm('{{$item->id}}','{{ __('shop::app.checkout.cart.cart-remove-action') }}')">{{ __('shop::app.checkout.cart.move-to-wishlist') }}</a>
                                                    @else
                                                        <a href="javascript:;" onclick="wishlistTempForm('{{$item->child->id}}','{{ __('shop::app.checkout.cart.cart-remove-action') }}')">{{ __('shop::app.checkout.cart.move-to-wishlist') }}</a>
                                                    @endif
                                                </span>
                                            @endauth
                                        </div>
...
@push('scripts')
    ...
    <script>
        function wishlistTempForm(id,message){
            if (confirm(message)){
                var form = document.createElement("form");
                form.method = 'post';
                form.action = "{{url('move/wishlist')}}/"+id;
