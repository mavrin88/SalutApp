                                ...
                                <li>
                                    <a href="{{ route('marketplace.account.products.edit', $item->product_id) }}">
                                        <div class="product image">
                                            <?php $getProductImageData = app('Webkul\Product\Repositories\ProductImageRepository')->where('product_id', $item->product_id)->get();
                    ...
                    <div class="card-info {{ !count($statistics['customer_with_most_sales']) ? 'center' : '' }}">
                        <ul>
                            ...
                            @foreach ($statistics['customer_with_most_sales'] as $item)
                                ...
                                <li>
                                @if ($item->customer_id)
                                    <a href="{{ route('marketplace.account.customers.order.index', encrypt($item->customer_email)) }}" style="text-decoration: none;">
                                @endif
