        ...
        <div class="account-items-list" style="margin-top: 40px;">
            ...
            <div class="graph-stats">
                ...
                <div class="card">
                    ...
                    <canvas id="myChart" style="width: 100%; height: 100%; max-height:380px; min-height:380px;"></canvas>
    ...
    <script type="text/x-template" id="earning-filter-template">
        <form action="" enctype="multipart/form-data" method="get"  @submit.prevent="applyFilter($event)">
            ...
            <div class="control-group date">
                <label for="start_date" class="required mandatory">{{ __('marketplace::app.shop.sellers.account.earning.start-date') }}</label>
            ...
            <div class="control-group date">
                <label for="end_date" class="required mandatory">{{ __('marketplace::app.shop.sellers.account.earning.end-date') }}</label>
            ...
            <div class="wk-mp-page-title mt-3" id="wk-mp-earning-form">
                <button class="btn btn-lg btn-primary" type="submit" id="save-btn"><span><span>{{ __('marketplace::app.shop.sellers.account.earning.show-report') }}</span>
                </button>
            </div>
        </form>
    </script>
