                ...
                <form class="form-group" method="POST" action="{{ route('marketplace.reviews.store', $seller->url) }}" @submit.prevent="onSubmit">
                    ...
                    <div class="form-container">
                        ...
                        <div class="control-group form-group" :class="[errors.has('comment') ? 'has-error' : '']">
                            ...
                            <textarea type="text" class="control" name="comment" v-validate="'required|max:500'" value="{{ old('comment') }}"  data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.reviews.comment') }}&quot;" style="height: 100px;">
                            </textarea>
