...
<div class="banner-container">
    ...
    @if (core()->getConfigData('marketplace.settings.velocity.banner'))
        <img class="banner" src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.banner')) }}"/>
    @else
    ...
    <div class="banner-content">
        ...
        <div class="account-action">
            <a href="{{ route('marketplace.seller.create') }}" class="btn theme-btn">
...
<div class="feature-container">
    ...
    <ul type="none" class="feature-list">
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_1') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_1'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_1')) }}"/>
        ...
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_2') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_2'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_2')) }}"/>
        ...
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_3') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_3'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_3')) }}"/>
        ...
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_4') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_4'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_4')) }}"/>
        ...
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_5') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_5'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_5')) }}"/>
        ...
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_6') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_6'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_6')) }}"/>
        ...
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_7') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_7'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_7')) }}"/>
        ...
        @if (core()->getConfigData('marketplace.settings.velocity.feature_icon_8') && core()->getConfigData('marketplace.settings.velocity.feature_icon_label_8'))
            <li>
                <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.feature_icon_8')) }}"/>
...
<?php $results = app('Webkul\Marketplace\Repositories\SellerRepository')->getPopularSellers(); ?>

@if ($results->count())
    <div class="velocity-popular-sellers-container" style="display: inline-block; width: 100%;">
            ...
            <div class="wrapper mb20">
                <div class="velocity-card">
                    @if ($seller->banner_url)
                        <div class="profile-upper" style="background-image: url({{ $seller->banner_url }})">
                    @else
                        <div class="profile-upper" style="background-image: url({{ asset('vendor/webkul/marketplace/assets/images/mp-velocity-banner.png') }})">
                    @endif
                        <div class="profile-image center-info">
                            @if ($logo = $seller->logo_url)
                                <img src="{{ $logo }}"/>
                            @else
                                <img src="{{ asset('vendor/webkul/marketplace/assets/images/default-velocity-logo.png') }}" />
                            @endif
                        </div>
                    </div>
...
<ul class="velocity-setup-step-list">
    <li>
        <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.setup_icon_1')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-1') }}</span>
    </li>

    <li>
        <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.setup_icon_2')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-2') }}</span>
    </li>

    <li>
        <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.setup_icon_3')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-3') }}</span>
    </li>

    <li>
        <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.setup_icon_4')) }}"/>

        <span>{{ __('marketplace::app.shop.marketplace.setup-4') }}</span>
    </li>

    <li>
        <img src="{{ asset('storage/'.core()->getConfigData('marketplace.settings.velocity.setup_icon_5')) }}"/>
