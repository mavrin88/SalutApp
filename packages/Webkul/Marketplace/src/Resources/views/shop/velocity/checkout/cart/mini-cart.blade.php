                ...
                <div
                    ...
                    <div class="col-3 product-image-container mr15">
                        ...
                        <a
                            ...
                            <div
                                class="product-image"
                                :style="
                                    `background-image: url(${item.images['small_image_url']});`
                                "
                    ...
                    <div class="col-9 no-padding card-body align-vertical-top">
                        <div class="no-padding">
                            ...
                            <div class="seller-info" :id ="`mini-cart-seller-info-${item.id}`" style="margin-bottom: 10px;">
                                <div v-if="item.seller_product">

                                    <div v-if="sellerInfo[item.product_id] && sellerInfo[item.product_id]['seller'] != 0" >
                                        Sold By: <a :href="`${$root.baseUrl}/marketplace/seller/profile/${item.seller_info.seller.url}`">@{{item.seller_info.seller.shop_title}} [<i class="material-icons" style="width: 12px; font-size: 10px;">star_rate</i>@{{item.seller_info.rating}}]</a>
                                    </div>                                    
