        ...
        <div class="account-head">
            ...
            <div class="account-action">
                @if (core()->getConfigData('marketplace.settings.general.can_cancel_order') && $sellerOrder->canCancel())
                    <a href="{{ route('marketplace.account.orders.cancel', $sellerOrder->order_id) }}" class="btn btn-primary theme-btn" v-alert:message="'{{ __('admin::app.sales.orders.cancel-confirm-msg') }}'">
                ...
                @if (core()->getConfigData('marketplace.settings.general.can_create_invoice') && $sellerOrder->canInvoice())
                    <a href="{{ route('marketplace.account.invoices.create', $sellerOrder->order_id) }}" class="btn btn-primary theme-btn">
                ...
                @if (core()->getConfigData('marketplace.settings.general.can_create_shipment') && $sellerOrder->canShip())
                    <a href="{{ route('marketplace.account.shipments.create', $sellerOrder->order_id) }}" class="btn btn-primary theme-btn">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($sellerOrder->items as $sellerOrderItem)
                                            <tr>
                                                ...
                                                <td data-value="{{ __('shop::app.customer.account.order.view.grand-total') }}">{{ core()->formatPrice($sellerOrder->grand_total, $sellerOrder->order->order_currency_code) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                        ...
                        @foreach ($sellerOrder->invoices as $sellerInvoice)
                            ...
                            <div class="sale-section">
                                <div class="secton-title">
                                    ...
                                    <a href="{{ route('marketplace.account.invoices.print', encrypt($sellerInvoice->marketplace_order_id)) }}" class="pull-right">
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                @if ($sellerShipment->shipment->inventory_source)
                                                    <tr>
                                                        <th>{{ __('marketplace::app.shop.sellers.account.sales.orders.inventory-source') }}</th>
                                                        <th>{{ $sellerShipment->shipment->inventory_source->name }}</th>
                                                    </tr>
                                                @endif

                                                <tr>
                                                    <th>{{ __('marketplace::app.shop.sellers.account.sales.orders.carrier-title') }}</th>
                                                    <th>{{ $sellerShipment->shipment->carrier_title }}</th>
                                                </tr>
