            ...
            <div class="sample-list">
                ...
                <ul type="none">
                    @foreach ($product->downloadable_samples as $sample)
                        <li>
                            <a class="remove-decoration" href="{{ route('marketplace.downloadable.download_sample', ['type' => 'sample', 'id' => $sample->id]) }}" target="_blank">
                                {{ $sample->title }}
                            </a>
                        </li>
                    @endforeach
                    ...
                    @foreach ($product->downloadable_links as $link)
                        <li>
                            <div class="checkbox col-12">
                                ...
                                <label for="{{ $link->id }}" class="checkbox-view"></label>
                                ...
                                @if ($link->sample_file || $link->sample_url)
                                    <a
                                        ...
                                        href="{{ route('marketplace.downloadable.download_sample', [
                                            'type' => 'link',
                                            'id' => $link->id
                                        ]) }}">
