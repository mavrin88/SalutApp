        ...
        <form method="post" action="{{ route('marketplace.account.seller.update', $seller->id) }}" @submit.prevent="onSubmit" enctype="multipart/form-data" class="account-table-content">
            <div class="account-head seller-profile-edit mb-10">
                ...
                <div class="account-action">
                    <a href="{{ route('marketplace.products.index', $seller->url) }}" target="_blank" class="btn theme-btn">
                        {{ __('marketplace::app.shop.sellers.account.profile.view-collection-page') }}
                    </a>

                    <a href="{{ route('marketplace.seller.show', $seller->url) }}" target="_blank" class="btn theme-btn">
            ...
            <div class="account-table-content">
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.general') }}'" :active="true">
                    <div slot="header">
                        {{ __('marketplace::app.shop.sellers.account.profile.general') }}
                    ...
                    <div slot="body">
                        <div class="form-group" :class="[errors.has('shop_title') ? 'has-error' : '']">
                            ...
                            <span class="control-error" v-if="errors.has('shop_title')" v-text="errors.first('shop_title')"></span>
                        </div>
                        ...
                        <div class="form-group" :class="[errors.has('phone') ? 'has-error' : '']">
                            ...
                            <input type="text" class="form-style" name="phone" v-validate="'required|integer'" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.profile.phone') }}&quot;" value="{{ old('phone') ?: $seller->phone }}">
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.media') }}'" :active="false">
                    ...
                    <div slot="header">
                        {{ __('marketplace::app.shop.sellers.account.profile.media') }}
                        <i class="icon expand-icon right"></i>
                    </div>
                    <div slot="body">
                        ...
                        <div class="form-group">
                            ...
                            <span>( {{ __('marketplace::app.shop.sellers.account.profile.file-size-2mb') }} )</span>
                        ...
                        <div class="form-group">
                            ...
                            <span>( {{ __('marketplace::app.shop.sellers.account.profile.file-size-6mb') }} )</span>
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.social_links') }}'" :active="false">
                    ...
                    <div slot="header">
                        {{ __('marketplace::app.shop.sellers.account.profile.social_links') }}
                        <i class="icon expand-icon right"></i>
                    </div>
                    <div slot="body">
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.policies') }}'" :active="false">
                    <div slot="header">
                        {{ __('marketplace::app.shop.sellers.account.profile.policies') }}
                        <i class="icon expand-icon right"></i>
                    </div>
                    <div slot="body">
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.admin-commission') }}'" :active="false">
                    <div slot="header">
                        {{ __('marketplace::app.shop.sellers.account.profile.admin-commission') }}
                        <i class="icon expand-icon right"></i>
                    </div>
                    <div slot="body">
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.seo') }}'" :active="false">
                    <div slot="header">
                        {{ __('marketplace::app.shop.sellers.account.profile.seo') }}
                        <i class="icon expand-icon right"></i>
                    </div>
                    <div slot="body">
                ...
                @if (core()->getConfigData('marketplace.settings.minimum_order_amount.enable'))
                    <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.minimum_amount') }}'" :active="false">
                        <div slot="header">
                            {{ __('marketplace::app.shop.sellers.account.profile.minimum_amount') }}
                            <i class="icon expand-icon right"></i>
                        </div>
                        <div slot="body">
                            ...
                            <div class="form-group">
                                ...
                                <span class="control-error" v-if="errors.has('min_order_amount')" v-text="errors.first('min_order_amount')"></span>
                            </div>
                ...
                @if (core()->getConfigData('marketplace.settings.google_analytics.enable'))
                    <accordian :title="'{{ __('marketplace::app.shop.sellers.account.profile.google_analytics') }}'" :active="false">
                        <div slot="header">
                            {{ __('marketplace::app.shop.sellers.account.profile.google_analytics') }}
                            <i class="icon expand-icon right"></i>
                        </div>
                        <div slot="body">
                            ...
                            <div class="form-group">
                                ...
                                <span class="control-error" v-if="errors.has('google_analytics_id')" v-text="errors.first('google_analytics_id')"></span>
                            </div>
