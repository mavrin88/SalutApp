...
<accordian :title="'{{ __('admin::app.catalog.products.videos') }}'" :active="false">
    <div slot="header">
        {{ __('admin::app.catalog.products.videos') }}
...
@push('scripts')
    ...
    <script type="text/x-template" id="product-video-template">
        <div>
            ...
            <label class="btn btn-sm btn-primary" style="display: inline-block; width: auto" @click="createFileType">
    ...
    <script>
        Vue.component('product-video', {
            ...
            data: function() {
                return {
                    videos: @if($product)@json($product->assignVideos)@else "" @endif,
