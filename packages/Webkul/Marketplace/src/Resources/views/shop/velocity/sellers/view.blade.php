...
@section('seo')
    ...
    <?php $productBaseImage = product_image()->getProductBaseImage($product, $images); ?>
                                ...
                                <div class="right col-lg-7 col-md-6">
                                    ...
                                    <div class="row info">
                                        ...
                                        <div class="col-12 price">
                                            @include ('shop::seller-group-products.price',
                                                ['product' => $product, 
                                                'associatePrice'=>$product->price])
                                    ...
                                    @include ('shop::seller-group-products.view.grouped-products')
