@if ($product->type == 'grouped')
    <accordian
        :title="'{{ __('marketplace::app.shop.sellers.account.catalog.products.grouped_product') }}'"
        :active="false"
    >
        <div slot="header">
    ...
    @push('scripts')
        <script
            ...
            id="grouped-product-section-template"
        >
        <div>
            ...
            <div class="table-responsive" style="margin-top: 20px;">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr
                            v-for='(groupedProduct, index) in grouped_products' 
                        ...
                        >
                            ...
                            <td>
                                <div class="control-group" :class="[errors.has(inputName(groupedProduct) + '[qty]') ? 'has-error' : '']">
                                    ...
                                    >
                                        @{{ errors.first(inputName(groupedProduct) + '[qty]') }}
                                    </span>
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                >
                                    ...
                                    >
                                        @{{ errors.first(inputName(groupedProduct) + '[sort_order]') }}
                                    </span>
                                </div>
                            </td>
                ...
                methods: {
                    ...
                    search: function() {
                        ...
                        if (this.search_term.length > 2) {
                            ...
                            this.$http.get("{{ route('shop.marketplace.search_simple_product') }}", {
                                    params: {
