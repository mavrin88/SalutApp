                                    ...
                                    @foreach ($cart->items as $key => $item)
                                        ...
                                        @php
                                            ...
                                            if (
                                                ...
                                                $sellerImages = $sellerProduct->findOneWhere(['marketplace_seller_id' => $item->additional['seller_info']['seller_id'], 'id' => $item->additional['product_id']])->images;
                                        ...
                                        <div class="row col-12" v-if="!isMobileDevice">
                                            ...
                                            <div class="product-details-content col-6 pr0">
                                                ...
                                                <div class="row col-12 no-padding no-margin">
                                                    @if (isset($item->additional['seller_info']))
                                                        @include ('marketplace::products.price', ['product' => $item])
                                                    @else
