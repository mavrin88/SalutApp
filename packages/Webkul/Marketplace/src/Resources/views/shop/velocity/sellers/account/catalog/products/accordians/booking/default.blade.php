    ...
    <script type="text/x-template" id="default-booking-template">
        <div>
            <div class="form-group" :class="[errors.has('booking[booking_type]') ? 'has-error' : '']">
                ...
                <select v-validate="'required'" name="booking[booking_type]" v-model="default_booking.booking_type" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.type') }}&quot;">
            ...
            <div v-if="default_booking.booking_type == 'many'">
                <div class="form-group" :class="[errors.has('booking[duration]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required|min_value:1'" name="booking[duration]" v-model="default_booking.duration" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.slot-duration') }}&quot;"/>
                ...
                <div class="form-group" :class="[errors.has('booking[break_time]') ? 'has-error' : '']">
                    ...
                    <input type="text" v-validate="'required|min_value:1'" name="booking[break_time]" v-model="default_booking.break_time" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.break-time') }}&quot;"/>
            ...
            <div class="section">
                ...
                <div class="section-content">
                                ...
                                <tr v-for="(day, index) in days">
                                    ...
                                    <td>
                                        <div class="form-group" :class="[errors.has('booking[slots][' + index + '][from]') ? 'has-error' : '']">
                                            <time-component>
                                                <input type="text" v-validate="parseInt(slots.many[index].status) ? 'required': ''" :name="'booking[slots][' + index + '][from]'" class="form-style" v-model="slots.many[index].from" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.from') }}&quot;">
                                            </time-component>
                                    ...
                                    <td>
                                        <div class="form-group" :class="[errors.has('booking[slots][' + index + '][to]') ? 'has-error' : '']">
                                            <time-component>
                                                <input type="text" v-validate="parseInt(slots.many[index].status) ? 'required': ''" :name="'booking[slots][' + index + '][to]'" class="form-style" v-model="slots.many[index].to" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.to') }}&quot;">
                                            </time-component>
                                    ...
                                    <td>
                                        <div class="form-group" :class="[errors.has('booking[slots][' + index + '][status]') ? 'has-error' : '']">
                                            <select v-validate="'required'" :name="'booking[slots][' + index + '][status]'" class="form-style" v-model="slots.many[index].status" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.status') }}&quot;">
                    ...
                    <div class="slot-list table" v-if="default_booking.booking_type == 'one'">
                        ...
                        <button type="button" class="btn btn-md btn-primary" style="margin-top: 20px" @click="addSlot()">
        ...
        <tr>
            <td class="has-form-group">
                <div class="form-group" :class="[errors.has(controlName + '[from_day]') ? 'has-error' : '']">
                    <select v-validate="'required'" :name="controlName + '[from_day]'" v-model="slotItem.from_day" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.day') }}&quot;">
            ...
            <td class="has-form-group">
                <div class="form-group" :class="[errors.has(controlName + '[to_day]') ? 'has-error' : '']">
                    <select v-validate="'required'" :name="controlName + '[to_day]'" v-model="slotItem.to_day" class="form-style" data-vv-as="&quot;{{ __('bookingproduct::app.admin.catalog.products.day') }}&quot;">
                        <option v-for="(day, index) in $parent.days" :value="index">@{{ day }}</option>
                    </select>
