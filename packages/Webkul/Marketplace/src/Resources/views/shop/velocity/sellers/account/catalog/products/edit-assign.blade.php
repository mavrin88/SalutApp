    ...
    <div class="account-layout right m10">
        ...
        <form method="POST" action="" enctype="multipart/form-data" @submit.prevent="onSubmit" class="account-table-content">
            ...
            <div class="account-table-content">
                ...
                <accordian :title="'{{ __('marketplace::app.shop.sellers.account.catalog.products.general') }}'" :active="true">
                    ...
                    <div slot="body">
                        ...
                        <div class="control-group" :class="[errors.has('price') ? 'has-error' : '']">
                            ...
                            <input type="text" v-validate="'required|decimal'" class="control" id="price" name="price" value="{{ old('price') ?: $product->price }}" data-vv-as="&quot;{{ __('marketplace::app.shop.sellers.account.catalog.products.price') }}&quot;" {{ in_array( $product->product->type, $allowPrice ) ? 'disabled' : '' }}/>
                ...
                @if (!in_array( $product->product->type, $allowInventory ))
                ...
                @if ($product->product->type == 'downloadable')
                    @include('marketplace::shop.velocity.sellers.account.catalog.products.accordians.downloadable', ['product' => $product->product])
                @endif
