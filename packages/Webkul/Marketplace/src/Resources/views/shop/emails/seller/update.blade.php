    ...
    <div style="padding: 30px;">
        ...
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('marketplace::app.mail.seller.update.dear', ['name' => $seller->customer->name]) }},
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">

                {{ __('marketplace::app.mail.seller.update.info') }}
            ...
            <p style="text-align: center;padding: 20px 0;">
                <a href="{{ route('shop.customer.session.index') }}" style="padding: 10px 20px;background: #0041FF;color: #ffffff;text-transform: uppercase;text-decoration: none; font-size: 16px">
                    {{ __('marketplace::app.mail.seller.update.login') }}
                </a>
            </p>
        </div>
