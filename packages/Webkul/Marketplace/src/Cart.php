...
class Cart
{
    ...
    public function __construct(
        ...
        protected MarketplaceProductRepository $mpProductRepository
    )
    {
        $this->initCart();
    }
    ...
    public function addProduct($productId, $data)
    {
        ...
        if (isset($data['seller_info'])) {
            ...
            $sellerOwnerProduct = $this->mpProductRepository->findOneWhere([
    ...
    public function prepareDataForOrder(): array
    {
        ...
        $finalData['billing_address']['gender'] = auth()->guard()->check() ? $finalData['customer']->gender : null;
