...
/**
 * Customer Order Data Grid class
 *
...
class CustomerOrderDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('marketplace_orders')
            ...
            ->select('orders.id', 'marketplace_orders.order_id', 'marketplace_orders.base_grand_total', 'marketplace_orders.base_shipping_amount', 'marketplace_orders.grand_total', 'marketplace_orders.created_at', 'channel_name', 'orders.status', 'orders.order_currency_code')
            ...
            ->where('orders.customer_email', $customerId);
        ...
        $this->addColumn([
            ...
            'closure'    => function ($row) {
                if (! is_null($row->base_grand_total)) {
                    return core()->formatPrice($row->base_grand_total - $row->base_shipping_amount, $row->order_currency_code);
                }
            }
        ]);
