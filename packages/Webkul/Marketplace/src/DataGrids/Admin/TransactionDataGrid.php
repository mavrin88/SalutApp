...
class TransactionDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('marketplace_transactions')
            ...
            ->addSelect(DB::raw('CONCAT(' . $table_prefix . 'customers.first_name, " ", ' . $table_prefix . 'customers.last_name) as seller_name'));
    ...
    public function prepareActions()
    {
        $this->addAction([
            'type'   => 'View',
            'route'  => 'marketplace.admin.account.transactions.view',
            'icon'   => 'icon eye-icon',
            'method' => 'GET',
            'title'  => 'View'
        ], true);
