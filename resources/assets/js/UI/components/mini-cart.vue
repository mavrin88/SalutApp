<template>
    <div :class="`dropdown ${cartItems.length > 0 ? '' : 'disable-active'}`">
        <a class="header__bar-list-item-link" :href="viewCartRoute"></a>
        <div class="header__bar-list-item-main">
            <div class="header__bar-list-item-icon">
                <svg class="header__bar-list-item-icon-svg">
                    <use class="header__bar-list-item-icon-use" href="/themes/salutarium/assets/images/sprite.svg#i-bar-4"></use>
                </svg>
            </div>
