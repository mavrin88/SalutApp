...
return [
    ...
    'customer'      => [
        ...
        'signup-form'       => [
            ...
            'form-signup-text'  => 'Если вы новичок в нашем магазине, мы рады видеть вас в качестве члена.',
        ],
        'forget-password'   => [
            'login'                 => 'Авторизоваться',
    ...
    'products'      => [
        ...
        'product-removed'  => 'Продукт больше недоступен, так как удален администратором',
    ],
