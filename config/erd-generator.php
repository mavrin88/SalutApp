...
//        base_path('app' . DIRECTORY_SEPARATOR . 'Models'),
        base_path('packages/Webkul/Attribute/src/Models'),
//        base_path('packages/Webkul/BookingProduct/src/Models'),
//        base_path('packages/Webkul/CartRule/src/Models'),
//        base_path('packages/Webkul/CatalogRule/src/Models'),
        base_path('packages/Webkul/Category/src/Models'),
//        base_path('packages/Webkul/Checkout/src/Models'),
//        base_path('packages/Webkul/CMS/src/Models'),
//        base_path('packages/Webkul/Core/src/Models'),
//        base_path('packages/Webkul/Customer/src/Models'),
        base_path('packages/Webkul/Inventory/src/Models'),
//        base_path('packages/Webkul/Marketing/src/Models'),
        base_path('packages/Webkul/Marketplace/src/Models'),
        base_path('packages/Webkul/MarketplaceWarehouse/src/Models'),
//        base_path('packages/Webkul/Notification/src/Models'),
        base_path('packages/Webkul/Product/src/Models'),
//        base_path('packages/Webkul/Sales/src/Models'),
//        base_path('packages/Webkul/Sitemap/src/Models'),
//        base_path('packages/Webkul/Tax/src/Models'),
//        base_path('packages/Webkul/User/src/Models'),
//        base_path('packages/Webkul/Velocity/src/Models'),
    ],
